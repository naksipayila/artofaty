...
const bannerImage = project.heroImage ?? project.images[0] ?? project.cover
...
<template>
  <section class="project-detail-hero">
    ...
    <div class="project-detail-hero__visual project-detail-reveal">
      <figure
        ref="bannerRef"
        class="project-detail-hero__card"
        :style="{
          '--hero-position': project.heroCrop,
          '--hero-scale': project.heroScale,
          '--hero-origin': project.heroOrigin
        }"
      >
        <img :src="bannerImage" :alt="`${project.title} banner image`">
      </figure>
    </div>
  </section>
  ...
  <section class="section project-detail-content-section project-detail-body">
    ...
    <div class="project-detail-gallery project-detail-reveal" style="--stagger: 3">
      <div class="project-detail-gallery__head">
    ...
    <Transition name="project-lightbox">
      ...
      >
        <div class="project-lightbox__bar">
          <span>{{ activeGalleryCount }} / {{ String(galleryImages.length).padStart(2, '0') }}</span>
          <button type="button" @click="closeGalleryImage">Close</button>
        </div>
        ...
        <figure class="project-lightbox__figure">
          <img :src="activeGalleryImage" :alt="`${project.title} enlarged gallery image ${activeGalleryCount}`">
        </figure>
